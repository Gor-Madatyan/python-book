...
-
- # OOD
- You start to `care` how to implement all that monstrosity that you **derived** from the abstract description
  > You can use `Solid` ideology, apply `Design Patterns` and such
- You choose your programming stack and think how to implement your ideas **(efficiently)** in the terms of e.g. your programming language